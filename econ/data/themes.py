"""Profile theme registry: purely cosmetic. A theme swaps .profile's
accent colour and adds a one-line flair underneath your rank -- no
gold price, no gameplay effect. Everyone starts with "parchment";
